...
import { IonContent, IonPage, IonToolbar, IonApp, IonRow, IonCol, IonIcon, IonLabel } from '@ionic/react';
		...
		<IonPage>
			...
			<IonToolbar slot="bottom" className="menu-tabs" style={{ paddingBottom: '20px' }}>
				<IonRow>
					...
					>
						<div className="home" style={{ display: 'flex', alignItems: 'center', color: '#fff' }}>
					...
					>
						<div className="chat" style={{ display: 'flex', alignItems: 'center', color: '#0090d4' }}>
					...
					>
						<div className="funds" style={{ display: 'flex', alignItems: 'center' }}>
