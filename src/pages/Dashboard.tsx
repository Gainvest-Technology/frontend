							...
							<div className="flex-container">
								<div className="flex-child">
									<IonCard className="card">
										...
										<IonCardContent className="card-content">Gainvest Score</IonCardContent>
									</IonCard>
								</div>
								<div className="flex-child">
									<IonCard className="card">
										<IonCardHeader className="level">Beginner</IonCardHeader>
										<IonCardContent className="card-content">Gainvestor Level</IonCardContent>
									</IonCard>
								</div>
							</div>
						</IonCol>
			...
			<IonToolbar slot="bottom" className="menu-tabs">
				<IonRow>
					...
					>
						...
						<IonLabel style={{ display: 'block', textAlign: 'center', fontSize: '11px' }}>
							Portfolio
						</IonLabel>
					</IonCol>
					<IonCol
